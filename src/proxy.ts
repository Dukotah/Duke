...
// Auth gate for the CRM: gates /crm + /api/crm, passes the verified session to
// route handlers via x-user-* request headers. Logic is unchanged from the
// previous middleware.ts.

    ...
    <button
      ...
      className={`group flex w-full items-center gap-4 rounded-2xl border p-4 text-left transition-all ${
        active
          ...
          : "border-hairline bg-ink-2 hover:border-hairline"
      }`}
    >
      <span
        className={`flex h-6 w-6 shrink-0 items-center justify-center rounded-md border transition-all ${
          active ? "border-copper bg-copper text-ink-0" : "border-zinc-600 text-transparent"
        }`}
      >
        ...
        <div className="max-w-3xl mx-auto">
          ...
          >
            ...
            <p
              ...
              style={{ color: "#DDAA75", filter: "drop-shadow(0 0 22px rgba(221,170,117,0.35))" }}
            >
              ...
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-2">
                  <input
                    ...
                    className="flex-1 bg-ink-3 border border-hairline rounded-full px-4 py-2.5 text-white placeholder-zinc-500 text-sm transition-all outline-none focus:border-copper focus:ring-4 focus:ring-copper/15 hover:border-zinc-600"
                  />
                  <button
          ...
          >
            ...
            <p className="mt-4 text-xs text-zinc-500">
              ...
              <Link href="/pricing" className="text-copper-bright underline-offset-2 hover:underline">
                See full pricing
              </Link>
            </p>
          </div>

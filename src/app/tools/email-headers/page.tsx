        ...
        <section className="relative overflow-hidden px-6 pt-20 pb-10 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <h1 className="text-balance text-4xl font-black tracking-tight sm:text-5xl">
              Email Header Inspector — Check SPF, DKIM &amp; DMARC
            </h1>
            <p className="text-pretty mx-auto mt-5 max-w-xl text-lg text-zinc-400">
              Paste raw email headers to verify SPF, DKIM, and DMARC authentication, trace the delivery path, and catch spoofing — all in your browser.
            </p>
          </div>
        </section>
        <section className="px-6 pb-24">
          <div className="mx-auto max-w-3xl">
            <ToolDeck initial="email-headers" />
          </div>
        </section>
      </main>
      <Footer />

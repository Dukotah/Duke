...
function IssueRow({ issue }: { issue: ComplianceIssue }) {
  ...
  return (
    <div className="flex items-start gap-3 px-4 py-3 border-b border-zinc-800 last:border-0 bg-[#18181B]">
  ...
  return (
    <div className="min-h-screen bg-[#18181B] text-white">
      ...
      <section className="pt-32 pb-12 px-6 text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h1 className="text-4xl sm:text-5xl font-black mb-4 leading-tight">
            ADA &amp; HIPAA{" "}
            <span className="text-orange-400">Compliance Checker</span>
          </h1>
      ...
      <div className="px-6 pb-6">
        <div className="max-w-3xl mx-auto bg-zinc-900 border border-zinc-800 rounded-xl px-5 py-3 text-xs text-zinc-500 text-center">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex flex-col sm:flex-row items-center justify-center gap-12">
                ...
                <div className="hidden sm:block w-px h-24 bg-zinc-800" />
            ...
            <div className="rounded-2xl p-6 text-center" style={{ border: "1px solid #F97316", background: "linear-gradient(135deg, #18181B 0%, #1C1917 100%)" }}>
              <p className="text-orange-400 text-xs font-semibold uppercase tracking-wider mb-2">Need Expert Help?</p>

        ...
        <section className="relative overflow-hidden px-6 pt-20 pb-10 text-center">
          <div className="mx-auto max-w-2xl">
            ...
            <h1 className="text-balance text-4xl font-black tracking-tight sm:text-5xl">
              ADA &amp; HIPAA Website Compliance Checker
            </h1>
            <p className="text-pretty mx-auto mt-5 max-w-xl text-lg text-zinc-400">
              Scan your site for WCAG accessibility violations and HIPAA privacy indicators. Get a
              scored report with actionable fixes — free, no signup.
            </p>
          </div>
        </section>
        <section className="px-6 pb-24">
          <div className="mx-auto max-w-3xl">
            <ToolDeck initial="security" />
          </div>
        </section>
      </main>
      <Footer />

...
import { createInboundLead } from "@/lib/crm/inbound";
...
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    // Persist the scored lead into the CRM. This never throws on a normal
    // "store unavailable" case — the email/report below is the primary job.

...
export async function GET(req: NextRequest) {
  try {
    ...
    return handleApiError("crm/claim GET", err);
  }
}
...
export async function POST(req: NextRequest) {
  try {
    ...
    const parsed = await parseJsonBody<{ leadId?: string; action?: "claim" | "unclaim" }>(req);
    ...
    return handleApiError("crm/claim POST", err);
  }
}

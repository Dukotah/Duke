...
export const metadata: Metadata = {
  title: "IT Support Healdsburg CA | Local Managed IT Services | Copper Bay Tech",
  description:
    "Local IT support for Healdsburg businesses. Network setup, managed services, cloud migration, and direct access — no ticket queues. Serving Healdsburg and all of Sonoma County.",
  keywords:
    "IT support Healdsburg, IT company Healdsburg CA, managed IT services Healdsburg, computer support Healdsburg, small business IT Healdsburg",
  alternates: { canonical: "https://copperbaytech.com/it-support-healdsburg" },
  openGraph: {
    title: "IT Support Healdsburg | Copper Bay Tech",
    description: "Local managed IT support for Healdsburg small businesses.",
    url: "https://copperbaytech.com/it-support-healdsburg",
...
const schema = {
  ...
  description: "Managed IT support for Healdsburg small businesses.",
};
  ...
  return (
    <>
      ...
      <main className="theme-dark min-h-screen bg-ink-0 text-white">
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-ink-0 pt-16">
          <div className="absolute inset-0 opacity-10">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <pattern id="topo-ithb" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
              ...
              <rect width="100%" height="100%" fill="url(#topo-ithb)" />
            </svg>
          </div>
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            <span className="inline-block mb-6 px-4 py-1.5 rounded-full text-xs font-semibold tracking-widest uppercase" style={{ backgroundColor: "rgba(221,170,117,0.15)", color: "#DDAA75", border: "1px solid rgba(221,170,117,0.3)", fontFamily: "var(--font-heading)" }}>
              Healdsburg, CA · IT Support
            </span>
            <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "var(--font-heading)" }}>
              IT support for<br />
              <span style={{ color: "#DDAA75" }}>Healdsburg businesses.</span>
            </h1>
            <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
              Reliable, local IT support for Healdsburg small businesses — from tasting rooms to dental offices. Direct access to a real person who knows your setup, not a helpdesk runaround.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/#contact" className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-md text-base font-bold text-ink-0 bg-copper hover:bg-copper-bright transition-colors" style={{ fontFamily: "var(--font-heading)" }}>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>What Healdsburg businesses get.</h2>
                ...
                <div className="mt-8">
                  <Link href="/#contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-md text-sm font-bold text-ink-0 bg-copper hover:bg-copper-bright transition-colors" style={{ fontFamily: "var(--font-heading)" }}>
                    Get a Free Assessment <ArrowRight size={14} />
                  </Link>
                </div>
              </div>
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-copper-bright mb-4" style={{ fontFamily: "var(--font-heading)" }}>Industries we support</p>
                <h3 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we work with in Healdsburg.</h3>
                <div className="grid grid-cols-2 gap-3">
                  {industries.map((ind) => (
                    <div key={ind} className="bg-ink-2 rounded-lg p-3 border border-hairline text-sm text-zinc-400" style={{ fontFamily: "var(--font-body)" }}>{ind}</div>
                  ))}
                </div>
              </div>
            </div>
        ...
        <section className="py-24 bg-ink-0">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <p className="text-2xl md:text-3xl font-bold text-white leading-snug mb-8" style={{ fontFamily: "var(--font-heading)" }}>
              &ldquo;Reservations, the POS, and our reservation tablets all run through Duke&apos;s setup now. It&apos;s rock solid during the busy season, and that peace of mind is worth everything to us.&rdquo;
            </p>
        ...
        <section className="py-16 bg-ink-1">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <p className="text-sm text-zinc-400" style={{ fontFamily: "var(--font-body)" }}>
              ...
              <Link href="/it-support-windsor" className="text-copper-bright font-semibold hover:underline">Windsor</Link>,{" "}
              <Link href="/it-support-santa-rosa" className="text-copper-bright font-semibold hover:underline">Santa Rosa</Link>,{" "}
              <Link href="/it-support-petaluma" className="text-copper-bright font-semibold hover:underline">Petaluma</Link>, and{" "}
              <Link href="/it-support-sonoma-county" className="text-copper-bright font-semibold hover:underline">across Sonoma County</Link>.
            </p>
          </div>
        </section>
        ...
        <section className="py-24 bg-ink-0">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Let&apos;s look at your setup.</h2>

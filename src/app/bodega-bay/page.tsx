...
export const metadata: Metadata = {
  title: "IT Support & Web Development in Bodega Bay | Copper Bay Tech",
  description:
    "Copper Bay Tech supports Bodega Bay's fishing, tourism, and coastal businesses with web development, IT support, and cybersecurity. Dependable Sonoma County service.",
};
...
const jsonLd = {
  ...
  description: "IT support and web development for Bodega Bay businesses.",
  telephone: "(707) 239-6725",
  email: "duke@copperbaytech.com",
  areaServed: "Bodega Bay, CA",
        ...
        <section className="pt-32 pb-20 bg-[#18181B]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              ...
              <br />
              <span style={{ color: "#F97316" }}>for Bodega Bay businesses.</span>
            </h1>
            <p className="text-white/60 text-lg max-w-xl mb-8" style={{ fontFamily: "var(--font-body)" }}>
              Bodega Bay's coastal businesses depend on a steady flow of visitors and a reputation for quality. We help you build and protect the digital side of that reputation — reliably, from someone nearby.
            </p>
            <Link
              href="/#contact"
        ...
        <section className="py-16 bg-[#FAFAF9]">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-[#18181B] mb-10" style={{ fontFamily: "var(--font-heading)" }}>
              Technology for Bodega Bay's coastal economy
            </h2>
              ...
              {[
                {
                  ...
                  body: "Visitors plan their Bodega Bay trips well in advance, and they start online. A compelling, fast-loading website for your inn, restaurant, charter, or shop means you get found — and chosen — before they ever leave home.",
                },
                {
                  icon: <Cpu size={22} />,
                  title: "IT Support",
                  body: "Remote coastal locations can mean tricky connectivity and limited local tech resources. We work with what you have, solve problems remotely when possible, and come out in person when it matters.",
                },
                {
                  icon: <ShieldCheck size={22} />,
                  title: "Cybersecurity",
                  body: "Tourism and hospitality businesses process lots of credit cards and personal data. We put in place the right protections — PCI compliance basics, secure email, and backup systems — to keep your business and customers safe.",
                },
              ].map((s) => (
            ...
            <div className="rounded-2xl bg-white border border-[#18181B]/10 p-8 shadow-sm mb-10">
              <h2 className="text-xl font-bold text-[#18181B] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Why local matters in Bodega Bay
              </h2>
              <p className="text-[#3F3F46]/70 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
                Running a business in Bodega Bay means dealing with unique challenges — from seasonal traffic swings to limited infrastructure. You need a tech partner who understands that, not one reading from a generic script. Copper Bay Tech knows Sonoma County's coast and has the flexibility to serve businesses in less-traveled corners of it.
              </p>
            </div>

            <p className="text-sm text-[#3F3F46]/50 mb-14" style={{ fontFamily: "var(--font-body)" }}>
              Practical tech advice for tourism businesses:{" "}
            ...
            <div className="rounded-2xl bg-[#18181B] p-10 text-center">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#F97316] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Serving Bodega Bay and all of Sonoma County
              </p>
              <h3 className="text-2xl font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Reliable technology, wherever you are on the Sonoma coast.
              </h3>
              <p className="text-white/60 text-sm mb-6 max-w-md mx-auto" style={{ fontFamily: "var(--font-body)" }}>
                ...
                <a href="mailto:duke@copperbaytech.com" className="text-white hover:text-[#F97316]">duke@copperbaytech.com</a> — no commitment needed.
              </p>
              <Link
                href="/#contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-md text-sm font-semibold text-[#18181B] bg-[#F97316] hover:bg-[#ea6c0a] transition-colors"

...
export const metadata: Metadata = {
  title: "IT Support & Web Development in Cotati | Copper Bay Tech",
  description:
    "Copper Bay Tech brings professional IT support, web development, and cybersecurity services to Cotati and the surrounding Sonoma County area. Small business friendly.",
};
...
const jsonLd = {
  ...
  description: "IT support and web development for Cotati businesses.",
  telephone: "(707) 239-6725",
  email: "duke@copperbaytech.com",
  areaServed: "Cotati, CA",
        ...
        <section className="pt-32 pb-20 bg-[#18181B]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              ...
              <br />
              <span style={{ color: "#F97316" }}>for Cotati businesses.</span>
            </h1>
            <p className="text-white/60 text-lg max-w-xl mb-8" style={{ fontFamily: "var(--font-body)" }}>
              Cotati's small-town character and the energy of nearby Sonoma State make it a unique place to run a business. We're here to make sure your technology supports that unique mix.
            </p>
            <Link
              href="/#contact"
        ...
        <section className="py-16 bg-[#FAFAF9]">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-[#18181B] mb-10" style={{ fontFamily: "var(--font-heading)" }}>
              Services for Cotati businesses
            </h2>
              ...
              {[
                {
                  ...
                  body: "Whether you're a restaurant on La Plaza, a music venue, or a professional services firm, a well-built website helps Cotati businesses reach more customers and look credible online. We build them right.",
                },
                {
                  icon: <Cpu size={22} />,
                  title: "IT Support",
                  body: "Don't let tech problems eat into your day. We handle everything from printer headaches to full network setups, providing reliable on-site and remote support to Cotati businesses of any size.",
                },
                {
                  icon: <ShieldCheck size={22} />,
                  title: "Cybersecurity",
                  body: "Small businesses are often easier targets than large corporations. We put solid, practical defenses in place — strong passwords policies, phishing protection, backups — without the enterprise price tag.",
                },
              ].map((s) => (
            ...
            <div className="rounded-2xl bg-white border border-[#18181B]/10 p-8 shadow-sm mb-10">
              <h2 className="text-xl font-bold text-[#18181B] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Why local matters in Cotati
              </h2>
              <p className="text-[#3F3F46]/70 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
                Cotati is a close-knit community where word of mouth still carries real weight. We think that's a good thing, and it means we're especially motivated to do excellent work here. Copper Bay Tech is based in Sonoma County — we're neighbors, not a distant call center — and we treat every Cotati client like a long-term relationship.
              </p>
            </div>

            <p className="text-sm text-[#3F3F46]/50 mb-14" style={{ fontFamily: "var(--font-body)" }}>
              Useful guides for small business owners:{" "}
              <Link href="/blog" className="text-[#F97316] underline underline-offset-2">Browse our resources →</Link>
            </p>
            ...
            <div className="rounded-2xl bg-[#18181B] p-10 text-center">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#F97316] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Serving Cotati and all of Sonoma County
              </p>
              <h3 className="text-2xl font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Straightforward tech help, right in your backyard.
              </h3>
              <p className="text-white/60 text-sm mb-6 max-w-md mx-auto" style={{ fontFamily: "var(--font-body)" }}>
                ...
                <a href="mailto:duke@copperbaytech.com" className="text-white hover:text-[#F97316]">duke@copperbaytech.com</a>. Let's talk.
              </p>
              <Link
                href="/#contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-md text-sm font-semibold text-[#18181B] bg-[#F97316] hover:bg-[#ea6c0a] transition-colors"

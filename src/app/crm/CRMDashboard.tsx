...
function AllLeads({
  ...
  return (
    <div className="space-y-3">
      {showBulkOutreach && (
        <BulkOutreach repName={userName} onClose={() => setShowBulkOutreach(false)} />
      )}

      {/* Search + Bulk Email button */}
      <div className="flex gap-2">
        ...
        <button
          ...
          className="inline-flex items-center gap-1.5 px-3 rounded-xl text-sm border transition-all bg-[#1C1C1F] text-[#F97316] border-[#F97316]/30 hover:bg-[#F97316]/10"
          style={H}
          title="Bulk Email"
        >
          <Mail size={13} />

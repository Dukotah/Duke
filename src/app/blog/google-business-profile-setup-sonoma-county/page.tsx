...
const articleSchema = {
  ...
  "@type": "Article",
  headline: "How to Set Up and Optimize Your Google Business Profile in Sonoma County",
  description:
    "A step-by-step guide to claiming, verifying, and optimizing your Google Business Profile so Sonoma County customers can find you in Google Maps and local search.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "How to Set Up and Optimize Your Google Business Profile in Sonoma County", item: "https://copperbaytech.com/blog/google-business-profile-setup-sonoma-county" },
  ],
};

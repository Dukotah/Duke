...
export default function Article() {
  return (
    <>
      ...
      <Nav />
      <main>
        <ArticleHeader tag="AI &amp; Automation" title="How AI Actually Helps a Sonoma County Small Business (2026)" date="June 2, 2026" readTime="6 min read" />
          ...
          <div className="max-w-2xl mx-auto px-6">
            <div style={{ fontFamily: "var(--font-body)" }}>
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                ...
                <Link href="/tools/missed-call-calculator" className="font-semibold text-copper-bright hover:underline">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                ...
                <Link href="/ai-integration-small-business" className="font-semibold text-copper-bright hover:underline">
                  AI integration
                </Link>{" "}
                or as an add-on to ongoing{" "}
                <Link href="/it-support-sonoma-county" className="font-semibold text-copper-bright hover:underline">
                  IT support
                </Link>
              ...
              <div className="bg-ink-2 rounded-xl p-6 text-center">
                ...
                <Link href="/ai-integration-small-business" className="inline-flex items-center gap-2 px-6 py-3 rounded-md text-sm font-semibold text-white bg-copper hover:bg-copper-bright transition-colors" style={{ fontFamily: "var(--font-heading)" }}>

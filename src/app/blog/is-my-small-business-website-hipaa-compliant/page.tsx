      ...
      <main>
        ...
        <section className="py-12 bg-ink-0">
          <div className="max-w-2xl mx-auto px-6">
            <p className="text-lg text-zinc-400 mb-8 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
            ...
            <h2 className="text-2xl font-bold text-white mt-8 mb-6" style={{ fontFamily: "var(--font-heading)" }}>The checklist</h2>
            <div className="space-y-4 mb-10">
              {checks.map((c, i) => (
                <div key={i} className="rounded-xl border border-hairline p-5 bg-ink-0">
                  <div className="flex items-start gap-3 mb-2">
                    <CheckCircle size={16} className="flex-shrink-0 mt-0.5" color="#16A34A" />
                    <p className="text-sm font-semibold text-white" style={{ fontFamily: "var(--font-heading)" }}>{c.item}</p>
                  </div>
                  <p className="text-sm text-zinc-400 pl-7 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>{c.what}</p>
                </div>
              ))}
            </div>
            <div className="p-5 rounded-xl bg-[#FFF7ED] border border-copper/20 text-sm text-zinc-400" style={{ fontFamily: "var(--font-body)" }}>
              <strong className="text-white">Note:</strong> This is not legal advice. HIPAA compliance is complex and fact-specific. Work with a qualified attorney alongside your technical team.
            </div>

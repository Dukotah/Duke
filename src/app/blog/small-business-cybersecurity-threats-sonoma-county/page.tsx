          ...
          <div className="max-w-2xl mx-auto px-6">
            <div style={{ fontFamily: "var(--font-body)" }}>
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                ...
                <Link href="/blog/hipaa-security-checklist-sonoma-county-healthcare" className="font-semibold text-copper-bright hover:underline">
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                ...
                <Link href="/blog/managed-it-support-vs-break-fix-sonoma-county" className="font-semibold text-copper-bright hover:underline">
                  managed IT support
                </Link>{" "}
              ...
              <p className="text-zinc-400 leading-relaxed mb-8">
                ...
                <Link href="/cybersecurity-small-business" className="font-semibold text-copper-bright hover:underline">
                  cybersecurity for small business
                </Link>
                , ongoing{" "}
                <Link href="/it-support-santa-rosa" className="font-semibold text-copper-bright hover:underline">
                  IT support in Santa Rosa
                </Link>{" "}
                and{" "}
                <Link href="/it-support-petaluma" className="font-semibold text-copper-bright hover:underline">
                  Petaluma
                </Link>

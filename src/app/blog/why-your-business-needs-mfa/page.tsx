...
export default function Article() {
  return (
    <>
      ...
      <Nav />
      <main>
        <ArticleHeader tag="Cybersecurity" title="Why Every Small Business Needs Multi-Factor Authentication (And How to Set It Up)" date="June 1, 2026" readTime="4 min read" />

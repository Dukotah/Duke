      ...
      <article className="pt-32 pb-24 px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mt-12 rounded-2xl p-6 border border-[#18181B]/10 bg-[#FAFAF9]">
            ...
            <a href="/#pricing" className="inline-block bg-[#F97316] hover:bg-[#ea6c0a] text-white font-bold px-6 py-2.5 rounded-full transition-colors text-sm" style={{ fontFamily: "var(--font-heading)" }}>
              Try the Estimator
            </a>
          </div>
        </div>

      ...
      <main>
        ...
        <section className="py-12 bg-ink-0">
          <div className="max-w-2xl mx-auto px-6" style={{ fontFamily: "var(--font-body)" }}>
            ...
            <p className="text-zinc-400 text-sm mb-6">$6–$18/user/month</p>
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>What Google Workspace does well:</h3>
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>Where it falls short:</h3>
            ...
            <p className="text-zinc-400 text-sm mb-6">$6–$22/user/month</p>
            <p className="text-zinc-400 mb-4 leading-relaxed">
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>What Microsoft 365 does well:</h3>
            <ul className="space-y-2 mb-6">
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              <div className="rounded-xl border border-hairline p-5 bg-ink-0">
                <p className="font-bold text-white mb-3 text-sm" style={{ fontFamily: "var(--font-heading)" }}>Choose Google Workspace if:</p>
              ...
              <div className="rounded-xl border border-hairline p-5 bg-ink-0">
                <p className="font-bold text-white mb-3 text-sm" style={{ fontFamily: "var(--font-heading)" }}>Choose Microsoft 365 if:</p>
                <ul className="space-y-2">
                  {[
            ...
            <div className="mt-10 p-6 rounded-2xl bg-ink-2 text-white">
              <p className="text-sm font-semibold mb-2 text-copper-bright" style={{ fontFamily: "var(--font-heading)" }}>Not sure which to pick?</p>

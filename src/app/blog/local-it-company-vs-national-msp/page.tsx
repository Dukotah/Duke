      ...
      <main>
        ...
        <section className="py-12 bg-ink-0">
          <div className="max-w-2xl mx-auto px-6" style={{ fontFamily: "var(--font-body)" }}>
            ...
            <p className="text-zinc-400 mb-10 leading-relaxed">
              Local IT companies are more likely to offer month-to-month or shorter commitments. That&apos;s not just a convenience — it&apos;s a signal of confidence. If a provider knows their service is good, they don&apos;t need to trap you. At <Link href="/it-support-sonoma-county" className="text-copper-bright underline underline-offset-2 hover:text-copper-bright transition-colors">Copper Bay Tech</Link>, we run month-to-month managed IT plans for exactly that reason.
            </p>
            ...
            <div className="grid sm:grid-cols-2 gap-4 mb-10">
              <div className="rounded-xl border border-hairline p-5 bg-ink-0">
                <p className="font-bold text-white mb-3 text-sm" style={{ fontFamily: "var(--font-heading)" }}>Choose a local IT company if:</p>
              ...
              <div className="rounded-xl border border-hairline p-5 bg-ink-0">
                <p className="font-bold text-white mb-3 text-sm" style={{ fontFamily: "var(--font-heading)" }}>A national MSP may make more sense if:</p>
                <ul className="space-y-2">
                  {[
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>What a local IT company does well:</h3>
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>Where a local IT company may fall short:</h3>
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>What a national MSP does well:</h3>
            <ul className="space-y-2 mb-6">
            ...
            <h3 className="font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>Where a national MSP tends to fall short for small businesses:</h3>
            <ul className="space-y-2 mb-10">
            ...
            <div className="mt-10 p-6 rounded-2xl bg-ink-2 text-white">
              <p className="text-sm font-semibold mb-2 text-copper-bright" style={{ fontFamily: "var(--font-heading)" }}>See if we&apos;re a good fit</p>
              <p className="text-sm text-white/70 mb-4">
                We offer flat-fee, month-to-month <Link href="/it-support-sonoma-county" className="text-copper-bright hover:text-copper-bright transition-colors underline underline-offset-2">IT support for Sonoma County businesses</Link> — no ticket queues, no lock-in, no per-device fees. Call (707) 239-6725 or start online.
              </p>
              <Link
                href="/get-started"

...
export const metadata: Metadata = {
  ...
  description:
    "Most small businesses hire their first IT vendor after something breaks. Here's what to look for — and what to avoid — before you're in crisis mode.",
  alternates: { canonical: "https://copperbaytech.com/blog/how-to-choose-an-it-company-sonoma-county" },
  openGraph: {
    title: "How to Choose an IT Company in Sonoma County",
    description:
      "Most small businesses hire their first IT vendor after something breaks. Here's what to look for — and what to avoid — before you're in crisis mode.",
    url: "https://copperbaytech.com/blog/how-to-choose-an-it-company-sonoma-county",
...
export default function Article() {
  return (
    <>
      ...
      <Nav />
      <main>
        <ArticleHeader tag="IT Support" title="How to Choose an IT Company in Sonoma County (Without Getting Burned)" date="May 1, 2026" readTime="5 min read" />

        <section className="py-12 bg-ink-0">
          <div className="max-w-2xl mx-auto px-6">
            <div
              className="prose prose-zinc max-w-none text-zinc-300 leading-relaxed"
            ...
            <div className="mt-12 pt-8 border-t border-hairline flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
              <Link
                href="/blog"

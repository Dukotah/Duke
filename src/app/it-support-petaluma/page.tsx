  ...
  return (
    <>
      ...
      <main className="theme-dark min-h-screen bg-ink-0 text-white">
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-ink-0 pt-16">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "var(--font-heading)" }}>
              IT support<br />
              <span style={{ color: "#DDAA75" }}>for Petaluma businesses.</span>
            </h1>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>What Petaluma businesses get.</h2>
              ...
              <div>
                <p className="text-xs font-semibold uppercase tracking-widest text-copper-bright mb-4" style={{ fontFamily: "var(--font-heading)" }}>Local to Sonoma County</p>
                <h3 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Local IT support that can actually show up.</h3>
                <div className="space-y-4">
                  {[
                    ...
                    <div key={item.label} className="flex gap-4 p-4 rounded-xl bg-ink-2 border border-hairline">
                      <div className="w-2 h-2 rounded-full bg-copper flex-shrink-0 mt-2" />
                      <div>
                        <p className="text-sm font-bold text-white mb-1" style={{ fontFamily: "var(--font-heading)" }}>{item.label}</p>
                        <p className="text-sm text-zinc-400" style={{ fontFamily: "var(--font-body)" }}>{item.body}</p>
                      </div>
                    </div>
                  ))}
                </div>
        ...
        <section className="py-24 bg-ink-1">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Let&apos;s talk about your IT situation.</h2>

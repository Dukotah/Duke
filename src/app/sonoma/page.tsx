...
export const metadata: Metadata = {
  ...
  description:
    "Copper Bay Tech helps Sonoma's wine country businesses with web development, IT support, and cybersecurity. Friendly, local, and deeply familiar with Sonoma Valley.",
};
...
const jsonLd = {
  ...
  description: "IT support and web development for Sonoma businesses.",
  telephone: "(707) 239-6725",
  email: "duke@copperbaytech.com",
  areaServed: "Sonoma, CA",
        ...
        <section className="pt-32 pb-20 bg-[#18181B]">
          <div className="max-w-4xl mx-auto px-6">
            ...
            >
              ...
              <br />
              <span style={{ color: "#F97316" }}>for Sonoma businesses.</span>
            </h1>
            <p className="text-white/60 text-lg max-w-xl mb-8" style={{ fontFamily: "var(--font-body)" }}>
              From the Plaza to the valley floor, Sonoma's wineries, tasting rooms, and hospitality businesses need technology that works as smoothly as a well-run harvest. We make that happen.
            </p>
            <Link
              href="/#contact"
        ...
        <section className="py-16 bg-[#FAFAF9]">
          <div className="max-w-4xl mx-auto px-6">
            <h2 className="text-2xl font-bold text-[#18181B] mb-10" style={{ fontFamily: "var(--font-heading)" }}>
              Technology services for Sonoma Valley
            </h2>
              ...
              {[
                {
                  ...
                  body: "Sonoma draws visitors from around the world, and your website is often the first impression. We build sites that do justice to your brand — beautiful, fast, and built to drive wine club signups, reservations, and online sales.",
                },
                {
                  icon: <Cpu size={22} />,
                  title: "IT Support",
                  body: "Point-of-sale systems, reservation platforms, winery management software — when any of it breaks, you feel it immediately. We keep Sonoma business infrastructure running with responsive on-site and remote support.",
                },
                {
                  icon: <ShieldCheck size={22} />,
                  title: "Cybersecurity",
                  body: "Customer payment data and wine club memberships are valuable targets. We protect your business with layered security that meets industry standards without requiring a dedicated IT department.",
                },
              ].map((s) => (
            ...
            <div className="rounded-2xl bg-white border border-[#18181B]/10 p-8 shadow-sm mb-10">
              <h2 className="text-xl font-bold text-[#18181B] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Why local matters in Sonoma
              </h2>
              <p className="text-[#3F3F46]/70 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
                The Sonoma Valley has a rhythm — harvest, harvest events, tourist season, harvest again. A tech partner who understands that rhythm knows when to prioritize and when an on-site visit the same day is the right call. We're close, we're familiar with wine country operations, and we treat your business like the serious enterprise it is.
              </p>
            </div>

            <p className="text-sm text-[#3F3F46]/50 mb-14" style={{ fontFamily: "var(--font-body)" }}>
              Helpful guides for Sonoma Valley businesses:{" "}
            ...
            <div className="rounded-2xl bg-[#18181B] p-10 text-center">
              <p className="text-xs font-semibold uppercase tracking-widest text-[#F97316] mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Serving Sonoma and all of Sonoma County
              </p>
              <h3 className="text-2xl font-bold text-white mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                Your technology should be the least of your worries.
              </h3>
              <p className="text-white/60 text-sm mb-6 max-w-md mx-auto" style={{ fontFamily: "var(--font-body)" }}>
                ...
                <a href="mailto:duke@copperbaytech.com" className="text-white hover:text-[#F97316]">duke@copperbaytech.com</a>. No commitment required.
              </p>
              <Link
                href="/#contact"
                className="inline-flex items-center gap-2 px-6 py-3 rounded-md text-sm font-semibold text-[#18181B] bg-[#F97316] hover:bg-[#ea6c0a] transition-colors"

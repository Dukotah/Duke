        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-ink-0 pt-16">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white leading-tight mb-6" style={{ fontFamily: "var(--font-heading)" }}>
              IT support for<br />
              <span style={{ color: "#DDAA75" }}>Windsor businesses.</span>
            </h1>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>What Windsor businesses get.</h2>
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we work with in Windsor.</h3>
        ...
        <section className="py-16 bg-ink-1">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <p className="text-sm text-zinc-400" style={{ fontFamily: "var(--font-body)" }}>
              ...
              <Link href="/it-support-healdsburg" className="text-copper-bright font-semibold hover:underline">Healdsburg</Link>,{" "}

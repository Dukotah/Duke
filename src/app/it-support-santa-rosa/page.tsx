...
export const metadata: Metadata = {
  title: "IT Support Santa Rosa CA | Local Managed IT Services | Copper Bay Tech",
  description:
    "Local IT support for Santa Rosa businesses. Network setup, managed services, cloud migration, and direct access — no ticket queues. Serving Santa Rosa and all of Sonoma County.",
  keywords:
    "IT support Santa Rosa, IT company Santa Rosa CA, managed IT services Santa Rosa, computer support Santa Rosa, small business IT Santa Rosa",
  alternates: { canonical: "https://copperbaytech.com/it-support-santa-rosa" },
  openGraph: {
    title: "IT Support Santa Rosa | Copper Bay Tech",
    description: "Local managed IT support for Santa Rosa small businesses.",
    url: "https://copperbaytech.com/it-support-santa-rosa",
    siteName: "Copper Bay Tech",
  },
};

const schema = serviceSchema({
  name: "IT Support Santa Rosa",
  description: "Managed IT support for Santa Rosa small businesses.",
  url: "https://copperbaytech.com/it-support-santa-rosa",
...
export default function ITSupportSantaRosa() {
  return (
    <>
      <JsonLd schema={schema} />
      <JsonLd schema={breadcrumbSchema([{name:"Home",url:"https://copperbaytech.com"},{name:"IT Support",url:"https://copperbaytech.com/it-support-sonoma-county"},{name:"IT Support Santa Rosa"}])} />
      <Nav />
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-ink-0 pt-16">
          <div className="absolute inset-0 opacity-10" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
              <defs>
                <pattern id="topo-itsr" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
              ...
              <rect width="100%" height="100%" fill="url(#topo-itsr)" />
            </svg>
          </div>
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            ...
            <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
              Reliable, local IT support for Santa Rosa small businesses. Direct access to a real person who knows your setup — not a helpdesk runaround.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>What Santa Rosa businesses get.</h2>
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we work with in Santa Rosa.</h3>

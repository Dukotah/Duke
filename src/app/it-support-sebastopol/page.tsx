...
export const metadata: Metadata = {
  title: "IT Support Sebastopol CA | Local Managed IT Services | Copper Bay Tech",
  description:
    "Local IT support for Sebastopol businesses. Network setup, managed services, cloud migration, and direct access — no ticket queues. Serving Sebastopol and all of Sonoma County.",
  keywords:
    "IT support Sebastopol, IT company Sebastopol CA, managed IT Sebastopol, computer support Sebastopol, small business IT Sebastopol",
  alternates: { canonical: "https://copperbaytech.com/it-support-sebastopol" },
  openGraph: {
    title: "IT Support Sebastopol | Copper Bay Tech",
    description: "Local managed IT support for Sebastopol small businesses.",
    url: "https://copperbaytech.com/it-support-sebastopol",
...
const schema = {
  ...
  areaServed: { "@type": "City", name: "Sebastopol", containedInPlace: { "@type": "State", name: "California" } },
  description: "Managed IT support for Sebastopol small businesses.",
  url: "https://copperbaytech.com/it-support-sebastopol",
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "IT Support Sebastopol" },
  ],
};
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-[#18181B] pt-16">
          <div className="absolute inset-0 opacity-10" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
              <defs>
                <pattern id="topo-itseb" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
              ...
              <rect width="100%" height="100%" fill="url(#topo-itseb)" />
            </svg>
          </div>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl font-bold text-[#18181B] mb-6" style={{ fontFamily: "var(--font-heading)" }}>What Sebastopol businesses get.</h2>
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-[#18181B] mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we work with in Sebastopol.</h3>
        ...
        <section className="py-24 bg-[#18181B]">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <p className="text-2xl md:text-3xl font-bold text-white leading-snug mb-8" style={{ fontFamily: "var(--font-heading)" }}>
              &ldquo;I&apos;d been trying to figure out our network situation for months. Duke came in, explained everything clearly, fixed it in a few hours, and left us with documentation we can actually use.&rdquo;
            </p>
            <p className="text-sm font-semibold text-white" style={{ fontFamily: "var(--font-heading)" }}>Carla M.</p>
            <p className="text-xs text-white/40" style={{ fontFamily: "var(--font-body)" }}>Owner, Sebastopol Wellness Studio</p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <p className="text-sm text-[#3F3F46]/60" style={{ fontFamily: "var(--font-body)" }}>
              ...
              <Link href="/it-support-petaluma" className="text-[#F97316] font-semibold hover:underline">Petaluma</Link>,{" "}
              <Link href="/it-support-santa-rosa" className="text-[#F97316] font-semibold hover:underline">Santa Rosa</Link>,{" "}
              <Link href="/it-support-windsor" className="text-[#F97316] font-semibold hover:underline">Windsor</Link>, and{" "}

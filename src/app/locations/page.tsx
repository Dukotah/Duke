      ...
      <main>
        ...
        <section className="py-20 bg-ink-1">
          <div className="max-w-5xl mx-auto px-6">
            <p
              className="text-zinc-400 text-sm mb-10 max-w-2xl"
              style={{ fontFamily: "var(--font-body)" }}
            >
                      ...
                      {availableServices.map((key) => {
                        ...
                        return (
                          <li key={key}>
                            <Link
                              href={href}
                              className="inline-flex items-center gap-1.5 text-sm font-semibold text-copper-bright hover:text-white transition-colors"
                              style={{ fontFamily: "var(--font-heading)" }}
                            >
                              <ArrowRight size={12} />
                              {meta.label}
        ...
        <section className="py-20 bg-ink-0">
          <div className="max-w-3xl mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/#contact"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-md font-bold text-ink-0 bg-copper hover:bg-copper-bright transition-colors"
                style={{ fontFamily: "var(--font-heading)" }}
              >
              ...
              <a
                href={BOOKING_URL}
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-md font-semibold border-2 border-hairline text-white hover:border-copper-dim transition-colors"
                style={{ fontFamily: "var(--font-heading)" }}
              >

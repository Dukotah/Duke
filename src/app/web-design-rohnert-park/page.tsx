      ...
      <main className="theme-dark min-h-screen bg-ink-0 text-white">
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-ink-0 pt-16">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            ...
            >
              Web design for<br />
              <span style={{ color: "#DDAA75" }}>Rohnert Park businesses.</span>
            </h1>
            <p
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we build for in Rohnert Park.</h3>
        ...
        <section className="py-24 bg-ink-1">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <p className="text-xs font-semibold uppercase tracking-widest text-copper-bright mb-4" style={{ fontFamily: "var(--font-heading)" }}>Based in Sonoma County</p>
            <h2 className="text-4xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>
              Your web designer is a neighbor, not a vendor.
            </h2>
            <p className="text-lg text-zinc-400 max-w-2xl mx-auto mb-12" style={{ fontFamily: "var(--font-body)" }}>
        ...
        <section className="py-16 bg-ink-1">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <p className="text-sm text-zinc-400" style={{ fontFamily: "var(--font-body)" }}>
              ...
              <Link href="/web-design-petaluma" className="text-copper-bright font-semibold hover:underline">Petaluma</Link>,{" "}
              <Link href="/web-design-santa-rosa" className="text-copper-bright font-semibold hover:underline">Santa Rosa</Link>, and{" "}
              <Link href="/web-design-sonoma-county" className="text-copper-bright font-semibold hover:underline">across Sonoma County</Link>.
            </p>
          </div>
        </section>

...
export const metadata: Metadata = {
  title: "IT Support Rohnert Park CA | Local Managed IT Services | Copper Bay Tech",
  description:
    "Local IT support for Rohnert Park businesses. Network setup, managed services, cloud migration, and direct access — no ticket queues. Serving Rohnert Park and all of Sonoma County.",
  keywords:
    "IT support Rohnert Park, IT company Rohnert Park CA, managed IT Rohnert Park, computer support Rohnert Park, small business IT Rohnert Park",
  alternates: { canonical: "https://copperbaytech.com/it-support-rohnert-park" },
  openGraph: {
    title: "IT Support Rohnert Park | Copper Bay Tech",
    description: "Local managed IT support for Rohnert Park small businesses.",
    url: "https://copperbaytech.com/it-support-rohnert-park",
...
const schema = {
  ...
  description: "Managed IT support for Rohnert Park small businesses.",
  url: "https://copperbaytech.com/it-support-rohnert-park",
};
...
const breadcrumb = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "IT Support Rohnert Park" },
  ],
};
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-[#18181B] pt-16">
          <div className="absolute inset-0 opacity-10" aria-hidden="true">
            <svg width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
              <defs>
                <pattern id="topo-itrp" x="0" y="0" width="80" height="80" patternUnits="userSpaceOnUse">
              ...
              <rect width="100%" height="100%" fill="url(#topo-itrp)" />
            </svg>
          </div>
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            ...
            <p className="text-lg md:text-xl text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed" style={{ fontFamily: "var(--font-body)" }}>
              Reliable, local IT support for Rohnert Park small businesses. Direct access to a real person who knows your setup — not a helpdesk runaround.
            </p>
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              <div>
                ...
                <h2 className="text-4xl font-bold text-[#18181B] mb-6" style={{ fontFamily: "var(--font-heading)" }}>What Rohnert Park businesses get.</h2>
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-[#18181B] mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we work with in Rohnert Park.</h3>
        ...
        <section className="py-24 bg-[#18181B]">
          <div className="max-w-3xl mx-auto px-6 text-center">
            <p className="text-2xl md:text-3xl font-bold text-white leading-snug mb-8" style={{ fontFamily: "var(--font-heading)" }}>
              &ldquo;We were running on a decade-old server that could&apos;ve gone down any day. Copper Bay Tech migrated everything to the cloud and set up proper backups. I sleep better now.&rdquo;
            </p>
            <p className="text-sm font-semibold text-white" style={{ fontFamily: "var(--font-heading)" }}>Tom B.</p>
            <p className="text-xs text-white/40" style={{ fontFamily: "var(--font-body)" }}>Owner, Rohnert Park Medical Supply</p>
        ...
        <section className="py-16 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <p className="text-sm text-[#3F3F46]/60" style={{ fontFamily: "var(--font-body)" }}>
              ...
              <Link href="/it-support-sebastopol" className="text-[#F97316] font-semibold hover:underline">Sebastopol</Link>, and{" "}

...
const blogPosts: Array<{ slug: string; lastModified: string; priority: number }> = [
  // June 2026 — software/web/automation batch
  { slug: "how-much-does-it-cost-to-build-an-app", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "do-i-need-an-app-or-a-website", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "what-is-a-web-application", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "website-maintenance-cost-and-whats-included", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "wordpress-vs-custom-coded-website", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "ecommerce-website-cost-for-small-business", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "custom-software-development-process", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "why-build-an-mvp-first", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "small-business-automation-ideas", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "build-vs-buy-a-crm", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "online-booking-system-for-small-business", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "integrating-your-business-software", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "ada-website-accessibility-small-business", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "what-to-prepare-before-hiring-a-web-developer", lastModified: "2026-06-29", priority: 0.8 },
  { slug: "redesign-vs-rebuild-your-website", lastModified: "2026-06-29", priority: 0.8 },
  // June 2026 — SEO/GEO cornerstone batch
  { slug: "how-to-choose-a-web-designer", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "do-i-still-need-a-website-in-2026", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "how-long-does-it-take-to-build-a-website", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "web-design-vs-web-development", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "local-web-developer-vs-offshore", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "how-much-does-custom-software-cost", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "custom-software-vs-off-the-shelf", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "what-is-custom-software-development", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "build-vs-buy-software", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "how-to-hire-a-software-development-company", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "signs-your-business-has-outgrown-spreadsheets", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "how-long-to-build-a-custom-web-app", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "get-your-business-recommended-by-ai", lastModified: "2026-06-27", priority: 0.8 },
  { slug: "what-makes-a-website-convert", lastModified: "2026-06-27", priority: 0.8 },
...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/software-development`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-santa-rosa`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-petaluma`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-healdsburg`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-windsor`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-rohnert-park`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-sebastopol`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-sonoma`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-guerneville`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-bodega-bay`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-glen-ellen`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE}/software-development-cotati`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },

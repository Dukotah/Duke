...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/industries/restaurants`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/industries/healthcare`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/industries/law-firms`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/industries/real-estate`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/industries/wineries`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    {
      url: `${base}/blog/what-is-a-managed-service-provider`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${base}/blog/small-business-website-cost-guide`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${base}/blog/why-your-business-needs-mfa`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },
    {
      url: `${base}/blog/how-to-speed-up-your-business-website`,
      lastModified: now,
      changeFrequency: "monthly",
      priority: 0.7,
    },

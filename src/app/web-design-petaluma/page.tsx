...
export default function WebDesignPetaluma() {
  return (
    <>
      ...
      <JsonLd schema={breadcrumbSchema([{name:"Home",url:"https://copperbaytech.com"},{name:"Web Design",url:"https://copperbaytech.com/web-design-sonoma-county"},{name:"Web Design Petaluma"}])} />
      <Nav />
      <main className="theme-dark min-h-screen bg-ink-0 text-white">
        ...
        <section className="relative min-h-[65vh] flex items-center justify-center overflow-hidden bg-ink-0 pt-16">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 text-center py-24">
            ...
            >
              Web design for<br />
              <span style={{ color: "#DDAA75" }}>Petaluma businesses.</span>
            </h1>
            <p
          ...
          <div className="max-w-5xl mx-auto px-6">
            <div className="grid md:grid-cols-2 gap-16 items-start">
              ...
              <div>
                ...
                <h3 className="text-2xl font-bold text-white mb-6" style={{ fontFamily: "var(--font-heading)" }}>Who we build for in Petaluma.</h3>
